...
--
-- Client: localhost
-- Généré le: Mar 13 Novembre 2012 à 18:14
...
(1, 'adminCo', 'admin', '', 'commande'),
(2, 'adminCl', 'admin', '', 'client');
...
(1, 'Plop', 'plop', '0101010101', 'plop@plop.com', 'plop', 'plop'),
(2, 'salut', 'salut', '0101010102', 'campos.thibault@gmail.com', 'plop', '0000');
...
(12, 'Commande de doliprane', 'rue dla pasteque', 'plopland', '77777', 'Plop', 'Plopi', 1, 1, 4520),
(13, 'Commande de Spasfon', 'ploplnd', 'sgdgdf', '22222', 'dfhdh', 'xfghxfgh', 1, 2, 4520);
...
INSERT INTO `commander` (`id_produit`, `id_commande`, `date_commande`, `quantite_produit`) VALUES
(2, 13, '2012-09-11', 23);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4523 ;
...
(1, 'SPASFON', '5bar', 0, '2'),
(2, 'bobotete3000', 'bobotete30', 0, '2500');
...
(1, 'En cours', 'En cour de préparation'),
(2, 'Expédiée', 'Commande expédiée');
